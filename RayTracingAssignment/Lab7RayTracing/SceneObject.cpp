...
void SceneObject::setCheckered(bool flag) {
	checkered_ = flag;
}

void SceneObject::setTextured(bool flag, int index) {
	textured_ = flag;
	texture_ = index;
}

void SceneObject::setFancy(bool flag) {
	fancy_ = flag;
}

bool SceneObject::isFancy() {
	return fancy_;
}
...
void SceneObject::setSpotlit(bool flag) {
	spotlit_ = flag;
}

bool SceneObject::isSpotlit() {
	return spotlit_;
}